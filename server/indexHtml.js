    ...
    <html lang="en" ${htmlAttrs}>
      <head>
        ...
        <!-- Global site tag (gtag.js) - Google Analytics -->
          <script async src="https://www.googletagmanager.com/gtag/js?id=UA-169253052-1"></script>
          ...
          })(window,document,'script','dataLayer','GTM-57P24SB');</script>
          <!-- End Google Tag Manager -->

      </head>
      <body ${bodyAttrs}>
        <!-- Google Tag Manager (noscript) -->
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-57P24SB"
