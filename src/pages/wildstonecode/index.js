...
class WildStoneCodeWhite extends Component {
  constructor(props) {
    ...
    this.wildstoneHeaderbg = wildstonecodeImagePath("banner.jpg");
    this.wildstonePattern = wildstonecodeImagePath("ws-pattern.jpg");
    this.wildstoneSpray1 = wildstonecodeImagePath("spray-left.jpg");
    this.wildstoneSpray2 = wildstonecodeImagePath("spray-right.jpg");
    this.wildstonemockup = wildstonecodeImagePath("mockup.jpg");
    this.state = {
      toggleHeader: false,
      showSayHello: false,
      footerBgColor: "dark",
